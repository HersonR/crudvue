...
export default{
    ...
    methods:{
        obtenerInformacionID(){
             ...
             fetch('http://localhost/pasteles/?consultar='+this.$route.params.id_pastel)
        ...
        actualizarRegistro(){
            var datosEnviar = {id_empleado:this.$route.params.id_pastel,
            nombre:this.pastel.nombre, descripcion:this.pastel.descripcion, preparado_por:this.pastel.preparado_por, fecha_creacion:this.pastel.fecha_creacion, fecha_vencimiento:this.pastel.fecha_vencimiento}

            fetch('http://localhost/pasteles/?actualizar='+this.$route.params.id_pastel,{
                method:"POST",
